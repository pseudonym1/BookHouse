 ...
 */
!function () {
    var Resident = my.Class({
        STATIC: {
            URL_LOAD_GRID: mast.basePath + "/pm/people/loadGridForResident.json",
            URL_QUERY: mast.basePath + "/pm/people/queryForResident.json",
        ...
        //楼宇搜索
        search: function (key) {
            this.dataList.datagrid("options").url = Resident.URL_SEARCH;
         ...
         */
        query: function () {
            this.mainGrid.datagrid('options').url = Resident.URL_QUERY;
